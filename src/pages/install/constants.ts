  ...
  EFFECT: {
    ...
    BEFORE: {
      ...
      ITEMS: [
        ...
        { text: "프로젝트당 300만원 이상 (전문 인력 시간당 비용 반영)", subtext: "", hasBr: false as const },
        { text: "색채학 지식, WCAG 지침에 대한 이해", subtext: "", hasBr: false as const },
        { text: "전체 CSS 파일 재검증 및 재작업 (반복 비용 발생)", subtext: "", hasBr: false as const },
        { text: "12% 이하 (높은 난이도로 인해 도입 포기)", subtext: "", hasBr: false as const },
      ],
    },
    AFTER: {
      LABEL: "AFTER",
      ...
      ITEMS: [
        { text: "45분 이내 (CLI 실행 및 ThemeProvider 통합)", subtext: "", hasBr: false as const },
        { text: "무료 (MIT License 오픈소스)", subtext: "", hasBr: false as const },
        { text: "일반 개발자 누구나 (전문 지식 불필요)", subtext: "", hasBr: false as const },
        { text: "CLI 한 줄 재실행 (10초 만에 자동 반영)", subtext: "", hasBr: false as const },
        { text: "목표 80% 이상 (진입 장벽 붕괴)", subtext: "", hasBr: false as const },
      ],
    },
  },
