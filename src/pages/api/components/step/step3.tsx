  ...
  return (
    <section className="flex flex-col gap-3 sm:gap-4">
      ...
      <section className="space-y-2 sm:space-y-3">
        ...
        <ul className="leading-7 sm:leading-8 list-inside list-disc">
          <Bullet>
          ...
          <ul className="leading-7 sm:leading-8 list-inside list-disc pl-4">
            <Bullet className="py-1">
              <Code>theme</Code> : 현재 적용된 테마의
              이름(문자열)
            </Bullet>
            <Bullet className="py-1">
              <Code>updateTheme</Code> :{" "}
              <Code>{`(theme: ThemeType) => void`}</Code>{" "}
              새로운 테마를 설정하는 함수.
            </Bullet>
            <Bullet className="py-1">
              <Code>language</Code> : 현재 적용된 테마의
              이름(문자열)
            </Bullet>
            <Bullet className="py-1">
              <Code>updateLanguage</Code> :{" "}
              <Code>{`(language: TLanguage) => void`}</Code>{" "}
              새로운 언어를 설정하는 함수.
            </Bullet>
          </ul>
          <Bullet>사용 예시: </Bullet>
